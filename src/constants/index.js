...
export const myProjects = [
  {
    title: "Org Chart",
    desc: "Org Chart App provides the ability to represent relations between the board items in interactive, dynamic, and collaborative org chart view.",
    subdesc:
  ...
  {
    title: "Resynced: Seamless Two-Way Sync for Your Data",
    desc: "Resynced offers a powerful and intuitive solution for synchronizing your data between platforms like monday.com, Google Sheets, and Notion",
    subdesc:
